        ...
        int count;
            ...
            for (i = 0; i < N_GHOSTS; i++) {
                if (ghost_x[i] % BLOCK_SIZE == 0 && ghost_y[i] % BLOCK_SIZE == 0) {
                    ...
                    // Bewege den Geist nach links, wenn es keinen Block links gibt und er nicht bereits nach rechts geht
                    if ((screenData[pos] & 1) == 0 && ghost_dx[i] != 1) {
                        dx[count] = -1;
                        dy[count] = 0;  // Nur horizontale Bewegung
                        count++;
                    }
            
                    // Bewege den Geist nach rechts, wenn es keinen Block rechts gibt und er nicht bereits nach links geht
                ...
                // Aktualisiere die Position des Geistes in horizontaler Richtung (nur x-Achse wird verändert)
